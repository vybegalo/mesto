...
export const popupConfirmDelete = document.querySelector('.popup__delete-element');
export const buttonConfirmDelete = popupConfirmDelete.querySelector('.popup__delete-button');
export const buttonSubmitPlace = popupAddPlace.querySelector('.popup__save');
